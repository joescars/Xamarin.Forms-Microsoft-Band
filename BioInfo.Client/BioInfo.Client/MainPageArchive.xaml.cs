...
{
    public partial class MainPageArchive : ContentPage
    {
        ...
        {
            await Task.Run(() => {
                SkinTemp = string.Format("Skin Temp: {0} °F",
                    CelsiusToFahrenheitConverter.Convert(e.SensorReading.Temperature).ToString("F2"));
            });            
        }
